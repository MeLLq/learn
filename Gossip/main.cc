...
int main(int ac, char **av) {
  ...
  /* app.add_options()("id", bpo::value<uint64_t>(), "Local peer id")(
       "ip", bpo::value<std::string>(), "Local ip address")(
       "port", bpo::value<uint16_t>(),
       "Local peer port"); (
 "payload", bpo::value<ss::sstring>(), "Path to local peer payload
 file")( "config", bpo::value<ss::sstring>(), "Path to local peer config
 file")( "peers", bpo::value<ss::sstring>(), "Path to peers file")*/
